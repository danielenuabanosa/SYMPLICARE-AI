...
import builtIcon from '@/app/assets/icons/built.png';
import processIcon from '@/app/assets/icons/process.png';
import teamIcon from '@/app/assets/icons/team.png';

export default function About() {
  return (
    <div className="w-full bg-gradient-to-b from-white via-[#f8fcfe] to-white dark:from-slate-900 dark:via-slate-900 dark:to-slate-900">
      <section className="relative py-20 bg-gradient-to-br from-[#0f172a] via-[#0c2340] to-[#1e1b4b] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 bg-white/15 border border-white/25 rounded-full px-4 py-2 text-sm text-white/90 mb-6 backdrop-blur-sm">
            <Image src={teamIcon} alt="" width={18} height={18} className="object-contain brightness-0 invert" /> Our Story
          </div>
      ...
      <Section className="py-12 md:py-16">
        <div className="grid grid-cols-1 items-start gap-8 md:grid-cols-[1.15fr_0.85fr] md:gap-10">
          <div className="max-w-2xl">
            ...
            <p className="mb-6 text-sm leading-7 text-slate-700 dark:text-slate-300">
          ...
          <div className="rounded-xl border border-[#c8e7f0] dark:border-slate-700 bg-gradient-to-br from-[#f0f9fc] to-white dark:from-slate-800 dark:to-slate-800 p-6 md:p-7 shadow-sm">
            <div className="space-y-6">
              <div>
                <h4 className="mb-2 font-semibold text-slate-950 dark:text-white">Our Mission</h4>
              ...
              <div className="border-t border-[#c8e7f0] dark:border-slate-700 pt-5">
                <h4 className="mb-2 font-semibold text-slate-950 dark:text-white">Our Values</h4>
      ...
      <Section id="founder-note" className="py-10 md:py-12 bg-gradient-to-br from-white via-[#f0f9fc] to-[#f8fcfe] dark:from-slate-900 dark:via-slate-900 dark:to-slate-900">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            <div className="h-1 w-12 bg-gradient-to-r from-[#77bdda] to-[#ca86bc]" />
            <h2 className="text-2xl font-semibold text-slate-950 dark:text-white">Founder&apos;s Note</h2>
          </div>

          <div className="bg-gradient-to-br from-[#f0f9fc] via-white to-[#f5e6f3] dark:from-slate-800 dark:via-slate-800 dark:to-slate-800 border border-[#c8e7f0] dark:border-slate-700 rounded-2xl p-6 md:p-8 space-y-5 text-slate-700 dark:text-slate-300 text-base leading-7 shadow-sm">
            ...
            <p className="text-slate-600 dark:text-slate-400 italic border-l-4 border-[#77bdda] pl-4">
            ...
            <p className="font-semibold text-slate-950 dark:text-white pt-2">That&apos;s what we&apos;re building.</p>
          </div>
        </div>
      </Section>

      <Section className="py-12 md:py-14 bg-gradient-to-br from-[#f0f9fc] via-white to-[#f8fcfe] dark:from-slate-900 dark:via-slate-900 dark:to-slate-900">
        <div className="text-center mb-10">
          <div className="flex justify-center items-center gap-2 mb-4">
            <div className="h-1 w-8 bg-gradient-to-r from-[#77bdda] to-[#6366f1]" />
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Why It Matters</h2>
            <div className="h-1 w-8 bg-gradient-to-r from-[#6366f1] to-[#ca86bc]" />
          </div>
          <p className="text-slate-500 dark:text-slate-400 text-sm">The real-world impact of better care operations</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="relative bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden border border-[#c8e7f0] dark:border-slate-700">
            ...
            <div className="mb-4 w-12 h-12 flex items-center justify-center">
              <Image src={targetIcon} alt="" width={48} height={48} className="object-contain" />
            </div>
            <h3 className="font-bold text-slate-900 dark:text-white mb-2">Better Outcomes</h3>
            <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">When systems are clear and processes are simple, teams can focus on what matters: quality care and resident wellbeing.</p>
          </div>
          <div className="relative bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden border border-[#c8e7f0] dark:border-slate-700">
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#6366f1] to-[#4338ca]" />
            <div className="mb-4 w-12 h-12 flex items-center justify-center">
              <Image src={flashIcon} alt="" width={48} height={48} className="object-contain" />
            </div>
            <h3 className="font-bold text-slate-900 dark:text-white mb-2">Reduced Burden</h3>
            <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Less time on administrative complexity means more time and energy for the people under their care.</p>
          </div>
          <div className="relative bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden border border-[#c8e7f0] dark:border-slate-700">
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#ca86bc] to-[#aa60a0]" />
            <div className="mb-4 w-12 h-12 flex items-center justify-center">
              <Image src={trustIcon} alt="" width={48} height={48} className="object-contain" />
            </div>
            <h3 className="font-bold text-slate-900 dark:text-white mb-2">Confidence</h3>
            <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Clear systems and organized information mean teams are prepared and confident for regulatory requirements.</p>
          </div>
        </div>
      </Section>

      <Section id="team" className="py-12 md:py-16 bg-gradient-to-b from-white via-[#f8fcfe] to-white dark:from-slate-900 dark:via-slate-900 dark:to-slate-900" heading="Meet Our Leadership" subheading="The team building care home solutions with real expertise">
      ...
      <section className="py-16 md:py-20 bg-gradient-to-br from-[#0f172a] via-[#0c2340] to-[#1e1b4b] relative overflow-hidden border-t-4 border-[#77bdda]">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { step: '01', title: 'Actively Learning', text: 'Working with care professionals to understand real-world operations in depth', icon: fileIcon, color: 'from-[#77bdda] to-[#5a9bb3]' },
              { step: '02', title: 'Building Core MVP', text: 'Creating the foundation that addresses the most pressing operational challenges', icon: builtIcon, color: 'from-[#6366f1] to-[#4338ca]' },
              { step: '03', title: 'Preparing Pilot', text: 'Getting ready to work with early adopter homes to test and refine our solutions', icon: processIcon, color: 'from-[#ca86bc] to-[#aa60a0]' },
            ].map((item, i) => (
              <div key={i} className="bg-white/8 backdrop-blur-sm border border-white/15 rounded-2xl p-6 hover:bg-white/12 transition-all duration-300 hover:-translate-y-1">
                <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center mb-4 shadow-lg overflow-hidden">
                  <Image src={item.icon} alt={item.title} width={36} height={36} className="object-contain p-1.5" />
                </div>
      ...
      <section className="relative py-20 overflow-hidden border-t border-slate-200 dark:border-slate-700">
