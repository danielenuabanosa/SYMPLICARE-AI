    ...
    <div className="w-full bg-white">
      <Section className="pt-24 md:pt-28" heading="Privacy Policy" subheading="How SympliCare AI handles information responsibly and transparently.">
        <div className="max-w-3xl space-y-8 text-slate-700 leading-7">
          <section>
            <h2 className="text-xl font-semibold text-slate-950 mb-3">Information We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-950 mb-3">How We Use Information</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-950 mb-3">Data Security</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-950 mb-3">Your Rights</h2>
