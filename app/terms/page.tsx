    ...
    <div className="w-full bg-white dark:bg-slate-900">
      <Section className="pt-24 md:pt-28" heading="Terms of Service" subheading="Simple terms for using the SympliCare AI website.">
        <div className="max-w-3xl space-y-8 text-slate-700 dark:text-slate-300 leading-7">
          <section>
            <h2 className="text-xl font-semibold text-slate-950 dark:text-white mb-3">Website Use</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-950 dark:text-white mb-3">No Clinical Advice</h2>
            <p>SympliCare AI does not provide clinical advice and does not replace professional regulatory responsibilities.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-slate-950 dark:text-white mb-3">Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-950 dark:text-white mb-3">Contact</h2>
